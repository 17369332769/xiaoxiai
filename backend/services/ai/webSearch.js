...
export const WEB_SEARCH_TOOL = {
  ...
  function: {
    name: 'web_search',
    description:
      '联网搜索实时或外部事实信息，结果来自互联网而非你的记忆。遇到以下问题必须调用本工具：天气、新闻、赛事比分、商品价格、汇率、近期或当下发生的事件、具体数据，以及任何关于“最新/最近/现在/今年/这段时间”某人、某公司、某产品、某技术的进展、动态、动作、版本或变化（例如“OpenAI 最近有什么新动作”“某明星最近怎么了”）。你的训练知识可能已经过时，凡涉及“最新/近期”的客观信息都不要凭记忆作答，必须先搜索。日常的情感陪伴、撒娇、安慰、闲聊不要调用。',
    parameters: {
      type: 'object',
      properties: {
        query: {
